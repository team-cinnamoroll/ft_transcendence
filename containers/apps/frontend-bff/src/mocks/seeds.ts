...
// ─── user-1 の 2025 年分の履歴シード（カレンダー映え用）───────────
const face1_historicalSeeds: Seed[] = [
  // 2025年3月
  {
    id: 'act-h-0',
    faceId: 'face-1-4',
