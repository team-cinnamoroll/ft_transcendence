...
export const ACCESS_TOKEN_MAX_AGE_SECONDS = 60 * 15; // 15分
export const REFRESH_TOKEN_MAX_AGE_SECONDS = 60 * 60 * 24 * 7; // 7日

// Middleware（src/proxy.ts）でリフレッシュ後のCookie書き込みにも使うため export する。
